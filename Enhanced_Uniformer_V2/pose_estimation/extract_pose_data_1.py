...
if __name__ == "__main__":
    ...
    input_folder = "/vol/bitbucket/sna21/dataset/UBI_FIGHTS/fight"      # Replace with your input folder
    output_folder = "/vol/bitbucket/sna21/dataset/UBI_FIGHTS/multi/pose_outputs/fight"  # Folder to save .npy files
